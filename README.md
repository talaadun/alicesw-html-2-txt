...
2026-05-09说明：书屋人员github上高强度自搜，并积极更新反爬措施，下方获取小说html的方式不一定行了💕💋
2026-05-03测试通过。
...
在一本小说的书页，点击"开始阅读"，然后在打开的小说阅读页面左侧的设置中，把阅读方式改为第二项（同一页面连续阅读），然后按住键盘的End键不放，直到该小说的所有章节内容都加载出来。然后使用SingleFile浏览器扩展下载此HTML页面即可。
